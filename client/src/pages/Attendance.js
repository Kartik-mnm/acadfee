    ...
    <div>
      <div className="page-header">
        <div>
          ...
          <div className="page-sub">Monthly attendance summary</div>
        </div>
            ...
            <table>
              <thead>
                <tr>
                  ...
                  <th>Batch</th><th>Total Days</th><th>Present</th><th>Absent</th><th>Percentage</th>
                </tr>
              </thead>
              <tbody>
                {records.map((r) => (
            ...
            <div className="modal-body">
              {bulkData.length === 0 ? (
                ...
                <div className="table-wrap">
                  <table>
                    <thead>
                      <tr><th>Student</th><th>Total Days</th><th>Present</th><th>%</th></tr>
                    </thead>
                    <tbody>
                      {bulkData.map((r, i) => (
                        <tr key={r.student_id}>
                          ...
                          <td style={{ color: pctColor(pct(r.present, r.total_days)), fontWeight: 700 }}>
                            {pct(r.present, r.total_days)}%
                          </td>
                        </tr>
                      ))}
                    </tbody>
