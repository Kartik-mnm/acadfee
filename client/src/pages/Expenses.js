              ...
              <div key={e.id} style={{ backgroundColor: '#1b2234', borderRadius: 24, padding: '20px', position: 'relative' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 4 }}>
                   <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                      ...
                      <h3 style={{ fontSize: 18, fontWeight: 700, margin: 0 }}>{e.category}</h3>
                   </div>
                   <button onClick={() => del(e.id)} style={{ width: 32, height: 32, borderRadius: 8, backgroundColor: 'rgba(239, 68, 68, 0.1)', color: '#ef4444', border: 'none', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                ...
                <div style={{ fontSize: 13, color: '#7c8b9d', marginBottom: 20, paddingLeft: 16 }}>{e.branch_name || 'main branch'}</div>
                ...
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                   <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                      ...
                      <div style={{ display: 'flex', alignItems: 'center', gap: 4, color: '#7c8b9d', fontSize: 12 }}>
                   ...
                   <div style={{ fontSize: 18, fontWeight: 700 }}>{fmt(e.amount)}</div>
                </div>
                ...
                <div style={{ borderTop: '1px solid rgba(255,255,255,0.05)', marginTop: 20, paddingTop: 16, display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                   ...
                   <span style={{ fontSize: 18, fontWeight: 800 }}>{fmt(e.amount)}.00</span>
                </div>
              </div>
            ))}
          </div>
