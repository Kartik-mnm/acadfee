...
export default function Login() {
  ...
  const Back = ({ label = "Back", to = null }) => (
    <button onClick={() => { setPanel(to); setError(""); setSuccess(""); }}
    ...
    <div className="login-bg">
      <div className="login-card">
        ...
        <div style={{ textAlign: "center", marginBottom: 28 }}>
          <div style={{ width: 64, height: 64, background: `linear-gradient(135deg,${primaryColor}26,${accentColor}1a)`, border: `1px solid ${accentColor}33`, borderRadius: 18, display: "flex", alignItems: "center", justifyContent: "center", margin: "0 auto 16px", boxShadow: `0 0 32px ${primaryColor}26` }}>
            {logoUrl
          ...
          <div style={{ fontSize: 20, fontWeight: 800, letterSpacing: "-0.4px", background: `linear-gradient(135deg,${primaryColor},${accentColor})`, WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>{academyName}</div>
          ...
          <div>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 20, padding: "10px 14px", borderRadius: 10, background: panel === "admin" ? `${primaryColor}14` : "rgba(16,217,160,0.08)", border: `1px solid ${panel === "admin" ? `${primaryColor}33` : "rgba(16,217,160,0.2)"}` }}>
              ...
              <div style={{ flex: 1 }}>
                ...
                <div style={{ fontSize: 11, color: "var(--text3)" }}>{panel === "admin" ? "Staff & managers login" : "Students login here"}</div>
              </div>
            </div>
        ...
        <div style={{ textAlign: "center", marginTop: 24, fontSize: 11, color: "var(--text3)" }}>{academyName} Management System</div>
      </div>
    </div>
  );
}
