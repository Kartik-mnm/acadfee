...
export default function AdmissionForm() {
  ...
  const printForm = () => {
    ...
    <div class="no-print" style="text-align:center;margin-top:20px">
      <button onclick="window.print()" style="padding:10px 28px;background:#cc0000;color:white;border:none;border-radius:6px;font-size:15px;cursor:pointer;font-weight:900">🖨 PRINT</button>
    </div>
    </body></html>`);
    w.document.close();
  };
  ...
  if (submitted) return (
    <div style={{ minHeight: "100vh", background: "#f5f5f5", display: "flex", alignItems: "center", justifyContent: "center", padding: 20 }}>
      <div style={{ background: "white", borderRadius: 16, padding: "40px", textAlign: "center", maxWidth: 400, boxShadow: "0 4px 24px rgba(0,0,0,0.1)" }}>
        ...
        <div style={{ fontSize: 14, color: "#555", lineHeight: 1.7 }}>Thank you for registering at<br/><strong>Nishchay Academy</strong>.<br/>Our team will contact you shortly.</div>
        <div style={{ marginTop: 20, padding: "12px", background: "#f0f7ff", borderRadius: 8, fontSize: 13, color: "#1565c0" }}>📞 8208145483 / 9371333013</div>
      </div>
    </div>
  );
      ...
      <div className="admission-form" style={{ maxWidth: 720, margin: "0 auto", background: "white", boxShadow: "0 4px 32px rgba(0,0,0,0.18)", borderRadius: 4 }}>
        ...
        <div style={{ padding: "20px 28px 16px", borderBottom: "4px solid #cc0000" }}>
          <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 20 }}>
            <img src="/nishchay-logo.png" alt="Nishchay Academy" style={{ width: 110, height: 110, objectFit: "contain", flexShrink: 0 }} />
            <div style={{ textAlign: "center" }}>
              <div style={{ fontSize: 36, fontWeight: 900, color: "#cc0000", fontFamily: "'Arial Black', Arial, sans-serif", letterSpacing: 2, lineHeight: 1 }}>NISHCHAY ACADEMY</div>
              <div style={{ fontSize: 11, color: "#333", marginTop: 8, lineHeight: 1.8 }}>
                Branch 1. Beside P.D. Hospital, Dabha, Khadgaon Road, Wadi, Nagpur- 23<br/>
                Branch 2. 1st Floor, Seva Medical, Dattwadi, Nagpur- 23<br/>
                Branch 3. G-34 , Sai Regency , Ravinagar , Nagpur -01<br/>
                Mob: 8208145483, 9371333013 &nbsp;|&nbsp; nishchayacademy20@gmail.com
        ...
        <div style={{ padding: "18px 28px" }}>
          ...
          {[{num:"1)",label:"FULL NAME OF STUDENT :",key:"name",required:true},{num:"2)",label:"FATHER NAME :",key:"father_name"},{num:"3)",label:"MOTHER NAME :",key:"mother_name"}].map((row) => (
            <div key={row.key} style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 12 }}>
              ...
              <span style={{ ...lbl, minWidth: 190 }}>{row.label}{row.required && <span style={{ color: "#cc0000" }}> *</span>}</span>
          ...
          {[{num:"11)",label:"STUDENT MOBILE NUMBER :",key:"phone",required:true,type:"tel"},{num:"12)",label:"PARENT MOBILE NUMBER :",key:"parent_phone",required:true,type:"tel"},{num:"13)",label:"EMAIL ID :",key:"email",type:"email"}].map((row) => (
            <div key={row.key} style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 12 }}>
              <span style={{ ...lbl, minWidth: 22 }}>{row.num}</span>
              <span style={{ ...lbl, minWidth: 220 }}>{row.label}{row.required && <span style={{ color: "#cc0000" }}> *</span>}</span>
          ...
          <div style={{ border: "2px solid #333", borderRadius: 4, padding: "14px 18px", marginBottom: 18 }}>
            ...
            <div style={{ fontSize: 12, lineHeight: 2, color: "#111" }}>
              I <span style={{ display: "inline-block", minWidth: 180, borderBottom: "1px solid #333" }}>&nbsp;</span> REQUEST TO ADMIT MY SON / DAUGHTER IN CLASS <span style={{ display: "inline-block", minWidth: 60, borderBottom: "1px solid #333" }}>&nbsp;</span> OF THE NISHCHAY ACADEMY, NAGPUR. I AGREE TO THE TERMS AND CONDITIONS OF THE INSTITUTE AND ASSURE TO ABIDE BY THEM. I ALSO UNDERTAKE TO PAY THE FEES LEVIED.
            </div>
